...
guideline and the [Akka Java Spring](http://www.lightbend.com/activator/template/akka-java-spring) tutorial
...
(see [Identifying Actors via Actor Selection](#actorselection-scala)). This can also be done with the `resolveOne` 
