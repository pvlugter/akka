 ...
 * **minor** and **patch** versions - please note that the meaning of "minor" has shifted to be more restrictive with Akka `2.4.0`, read [Change in versioning scheme, stronger compatibility since 2.4](#24versioningchange) for details.
...
Specific examples (please read [Change in versioning scheme, stronger compatibility since 2.4](#24versioningchange) to understand the difference in "before 2.4 era" and "after 2.4 era"):
 ...
 * all @ref:[may change](may-change.md) modules - which by definition are subject to rapid iteration and change. Read more about that in @ref:[Modules marked "May Change"](may-change.md#may-change)
